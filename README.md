...
```bash
$ git clone https://github.com/davidlouis17/chatbot
$ cd chatbot
$ npm install
$ node index.js
```
...
$ cd chatbot
```
Sesudah menginstall file node_modules, silahkan extract file ```node_modules.zip``` dan taruh di folder chatbot.
